...
KR=diag([0.1 0.1 0.1 1 1 1 1 1 1]);
Q=Q*KQ;
R=R*KR;
...
ned_yt = data(:,14);
ned_zt = data(:,15);
figure;plot(ned_xt,'-r');hold on;plot(ned_x_EKF,'-g');
figure;plot(ned_yt,'-r');hold on;plot(ned_y_EKF,'-g');
figure;plot(ned_zt,'-r');hold on;plot(ned_z_EKF,'-g');
