...
A2=[ ( 2*q0*(1-2*(q1^2+q2^2))+8*q1*(q2*q3+q0*q1) )/((1-2*(q1^2+q2^2))^2+4*(q2*q3+q0*q1)^2);
    -2*q3/(sqrt(1-4*(q1*q3-q0*q2)^2));
    2*q2*(1-2*(q3^2+q2^2))/((1-2*(q3^2+q2^2))^2+4*(q2*q1+q0*q3)^2)];
A3=[(2*q3*(1-2*(q1^2+q2^2))+8*q2*(q2*q3+q0*q1))/((1-2*(q1^2+q2^2))^2+4*(q2*q3+q0*q1)^2);
    2*q0/(sqrt(1-4*(q1*q3-q0*q2)^2));
    (2*q1*(1-2*(q3^2+q2^2))+8*q2*(q1*q2+q0*q3))/((1-2*(q3^2+q2^2))^2+4*(q2*q1+q0*q3)^2)];
A4=[2*q2*(1-2*(q1^2+q2^2))/((1-2*(q1^2+q2^2))^2+4*(q2*q3+q0*q1)^2);
    -2*q1/(sqrt(1-4*(q1*q3-q0*q2)^2));
    (2*q0*(1-2*(q3^2+q2^2))+8*q3*(q0*q3+q1*q2))/((1-2*(q3^2+q2^2))^2+4*(q2*q1+q0*q3)^2)];
A5=zeros(3,6);
